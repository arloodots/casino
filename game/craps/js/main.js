...
(function() {
    ...
    function b(b, c) {
        ...
        return !/^(?:boolean|number|string|undefined)$/.test(a) &&
            ("object" == a ? !!b[c] : !0)
    }
    ...
    function c(a) {
        function g(b) {
            return l(b, function(b, c) {
                var h = c.pattern || f(c);
                !b && (b = RegExp("\\b" + h + " *\\d+[.\\w_]*", "i").exec(a) || RegExp("\\b" + h + " *\\w+-[\\w]*", "i").exec(a) || RegExp("\\b" + h + "(?:; *(?:[a-z]+[_-])?[a-z]+\\d+|[^ ();-]*)", "i").exec(a)) && ((b = String(c.label && !RegExp(h, "i").test(c.label) ? c.label : b).split("/"))[1] && !/[\d.]+/.test(b[0]) && (b[0] +=
                    " " + b[1]), c = c.label || c, b = d(b[0].replace(RegExp(h, "i"), c).replace(RegExp("; *(?:" + c + "[_-])?", "i"), " ").replace(RegExp("(" + c + ")[-_.]?(\\w)", "i"), "$1 $2")));
                return b
            })
        }
        ...
        var K = t.navigator || {},
            x = K.userAgent || "";
        a || (a = x);
        var y = m ? !!K.likeChrome : /\bChrome\b/.test(a) && !/internal|\n/i.test(q.toString()),
        ...
        var B = function(b) {
            ...
            G = function(b) {
                return l(b, function(b, c, d) {
                    return b || (c[C] || c[/^[a-z]+(?: +[a-z]+\b)*/i.exec(C)] || RegExp("\\b" + f(d) + "(?:\\b|\\w*\\d)", "i").exec(a)) && d
                })
            }({
                Apple: {
                    iPad: 1,
            ...
            v = function(b) {
                return l(b, function(b, c) {
                    var h = c.pattern || f(c);
                    if (!b && (b = RegExp("\\b" + h + "(?:/[\\d.]+|[ \\w.]*)", "i").exec(a))) {
                        var g = b,
                            l = c.label || c,
                            e = {
                                "10.0": "10",
                        ...
                        h && l && /^Win/i.test(g) && !/^Windows Phone /i.test(g) && (e = e[/[\d.]+$/.exec(g)]) && (g = "Windows " + e);
                        g = String(g);
                        h && l && (g = g.replace(RegExp(h, "i"), l));
                        b = g = d(g.replace(/ ce$/i, " CE").replace(/\bhpw/i, "web").replace(/\bMacintosh\b/, "Mac OS").replace(/_PowerPC\b/i, " OS").replace(/\b(OS X) [^ \d]+/i, "$1").replace(/\bMac (OS X)\b/, "$1").replace(/\/(\d)/,
        ...
        "IE" == u && /\blike iPhone OS\b/.test(a) ? (k = c(a.replace(/like iPhone OS/, "")), G = k.manufacturer, C = k.product) : /^iP/.test(C) ? (u || (u = "Safari"), v = "iOS" + ((k = / OS ([\d_]+)/i.exec(a)) ? " " + k[1].replace(/_/g, ".") : "")) : "Konqueror" != u || /buntu/i.test(v) ? G && "Google" != G && (/Chrome/.test(u) &&
            !/\bMobile Safari\b/i.test(a) || /\bVita\b/.test(C)) || /\bAndroid\b/.test(v) && /^Chrome/.test(u) && /\bVersion\//i.test(a) ? (u = "Android Browser", v = /\bAndroid\b/.test(v) ? v : "Android") : "Silk" == u ? (/\bMobi/i.test(a) || (v = "Android", m.unshift("desktop mode")), /Accelerated *= *true/i.test(a) && m.unshift("accelerated")) : "PaleMoon" == u && (k = /\bFirefox\/([\d.]+)\b/.exec(a)) ? m.push("identifying as Firefox " + k[1]) : "Firefox" == u && (k = /\b(Mobile|Tablet|TV)\b/i.exec(a)) ? (v || (v = "Firefox OS"), C || (C = k[1])) : !u || (k = !/\bMinefield\b/i.test(a) &&
            /\b(?:Firefox|Safari)\b/.exec(u)) ? (u && !C && /[\/,]|^[^(]+?\)/.test(a.slice(a.indexOf(k + "/") + 8)) && (u = null), (k = C || G || v) && (C || G || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(v)) && (u = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(v) ? v : k) + " Browser")) : "Electron" == u && (k = (/\bChrome\/([\d.]+)\b/.exec(a) || 0)[1]) && m.push("Chromium " + k) : v = "Kubuntu";
        x || (x = p(["(?:Cloud9|CriOS|CrMo|Edge|FxiOS|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$))", "Version", f(u), "(?:Firefox|Minefield|NetFront)"]));
        if (k = "iCab" == B && 3 < parseFloat(x) && "WebKit" || /\bOpera\b/.test(u) && (/\bOPR\b/.test(a) ? "Blink" : "Presto") || /\b(?:Midori|Nook|Safari)\b/i.test(a) && !/^(?:Trident|EdgeHTML)$/.test(B) && "WebKit" || !B && /\bMSIE\b/i.test(a) && ("Mac OS" == v ? "Tasman" : "Trident") || "WebKit" == B && /\bPlayStation\b(?! Vita\b)/i.test(u) && "NetFront") B = [k];
        "IE" == u && (k = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(a) || 0)[1]) ? (u += " Mobile", v = "Windows Phone " + (/\+$/.test(k) ? k : k + ".x"), m.unshift("desktop mode")) : /\bWPDesktop\b/i.test(a) ? (u = "IE Mobile", v = "Windows Phone 8.x",
            m.unshift("desktop mode"), x || (x = (/\brv:([\d.]+)/.exec(a) || 0)[1])) : "IE" != u && "Trident" == B && (k = /\brv:([\d.]+)/.exec(a)) && (u && m.push("identifying as " + u + (x ? " " + x : "")), u = "IE", x = k[1]);
        if (I) {
            if (b(t, "global"))
                if (z && (k = z.lang.System, M = k.getProperty("os.arch"), v = v || k.getProperty("os.name") + " " + k.getProperty("os.version")), A) {
                    try {
                        x = t.require("ringo/engine").version.join("."), u = "RingoJS"
                    } catch (Q) {
                        (k = t.system) && k.global.system == t.system && (u = "Narwhal", v || (v = k[0].os || null))
                    }
                    u || (u = "Rhino")
                } else "object" == typeof t.process &&
                    !t.process.browser && (k = t.process) && ("object" == typeof k.versions && ("string" == typeof k.versions.electron ? (m.push("Node " + k.versions.node), u = "Electron", x = k.versions.electron) : "string" == typeof k.versions.nw && (m.push("Chromium " + x, "Node " + k.versions.node), u = "NW.js", x = k.versions.nw)), u || (u = "Node.js", M = k.arch, v = k.platform, x = (x = /[\d.]+/.exec(k.version)) ? x[0] : null));
            else h(k = t.runtime) == w ? (u = "Adobe AIR", v = k.flash.system.Capabilities.os) : h(k = t.phantom) == D ? (u = "PhantomJS", x = (k = k.version || null) && k.major + "." + k.minor +
                "." + k.patch) : "number" == typeof O.documentMode && (k = /\bTrident\/(\d+)/i.exec(a)) ? (x = [x, O.documentMode], (k = +k[1] + 4) != x[1] && (m.push("IE " + x[1] + " mode"), B && (B[1] = ""), x[1] = k), x = "IE" == u ? String(x[1].toFixed(1)) : x[0]) : "number" == typeof O.documentMode && /^(?:Chrome|Firefox)\b/.test(u) && (m.push("masking as " + u + " " + x), u = "IE", x = "11.0", B = ["Trident"], v = "Windows");
            v = v && d(v)
        }
        x && (k = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(x) || /(?:alpha|beta)(?: ?\d)?/i.exec(a + ";" + (I && K.appMinorVersion)) || /\bMinefield\b/i.test(a) &&
            "a") && (N = /b/i.test(k) ? "beta" : "alpha", x = x.replace(RegExp(k + "\\+?$"), "") + ("beta" == N ? S : R) + (/\d+\+?/.exec(k) || ""));
        if ("Fennec" == u || "Firefox" == u && /\b(?:Android|Firefox OS)\b/.test(v)) u = "Firefox Mobile";
        else if ("Maxthon" == u && x) x = x.replace(/\.[\d.]+/, ".x");
        else if (/\bXbox\b/i.test(C)) "Xbox 360" == C && (v = null), "Xbox 360" == C && /\bIEMobile\b/.test(a) && m.unshift("mobile mode");
            ...
            if ("IE" == u && I) try {
                ...
                m.unshift("embedded")
            } else(/\bBlackBerry\b/.test(C) || /\bBB10\b/.test(a)) && (k = (RegExp(C.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(a) || 0)[1] || x) ? (k = [k, /BB10/.test(a)], v = (k[1] ? (C = null, G = "BlackBerry") : "Device Software") + " " + k[0], x = null) : this != e && "Wii" != C && (I && H || /Opera/.test(u) && /\b(?:MSIE|Firefox)\b/i.test(a) || "Firefox" == u && /\bOS X (?:\d+\.){2,}/.test(v) || "IE" == u && (v && !/^Win/.test(v) && 5.5 < x || /\bWindows XP\b/.test(v) && 8 < x || 8 == x && !/\bTrident\b/.test(a))) && !n.test(k =
                c.call(e, a.replace(n, "") + ";")) && k.name && (k = "ing as " + k.name + ((k = k.version) ? " " + k : ""), n.test(u) ? (/\bIE\b/.test(k) && "Mac OS" == v && (v = null), k = "identify" + k) : (k = "mask" + k, u = L ? d(L.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera", /\bIE\b/.test(k) && (v = null), I || (x = null)), B = ["Presto"], m.push(k));
            else u += " Mobile";
        if (k = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(a) || 0)[1]) {
            k = [parseFloat(k.replace(/\.(\d)$/, ".0$1")), k];
            if ("Safari" == u && "+" == k[1].slice(-1)) u = "WebKit Nightly", N = "alpha", x = k[1].slice(0, -1);
            else if (x == k[1] || x == (k[2] =
                    (/\bSafari\/([\d.]+\+?)/i.exec(a) || 0)[1])) x = null;
            k[1] = (/\bChrome\/([\d.]+)/i.exec(a) || 0)[1];
            537.36 == k[0] && 537.36 == k[2] && 28 <= parseFloat(k[1]) && "WebKit" == B && (B = ["Blink"]);
            I && (y || k[1]) ? (B && (B[1] = "like Chrome"), k = k[1] || (k = k[0], 530 > k ? 1 : 532 > k ? 2 : 532.05 > k ? 3 : 533 > k ? 4 : 534.03 > k ? 5 : 534.07 > k ? 6 : 534.1 > k ? 7 : 534.13 > k ? 8 : 534.16 > k ? 9 : 534.24 > k ? 10 : 534.3 > k ? 11 : 535.01 > k ? 12 : 535.02 > k ? "13+" : 535.07 > k ? 15 : 535.11 > k ? 16 : 535.19 > k ? 17 : 536.05 > k ? 18 : 536.1 > k ? 19 : 537.01 > k ? 20 : 537.11 > k ? "21+" : 537.13 > k ? 23 : 537.18 > k ? 24 : 537.24 > k ? 25 : 537.36 > k ? 26 : "Blink" !=
                B ? "27" : "28")) : (B && (B[1] = "like Safari"), k = (k = k[0], 400 > k ? 1 : 500 > k ? 2 : 526 > k ? 3 : 533 > k ? 4 : 534 > k ? "4+" : 535 > k ? 5 : 537 > k ? 6 : 538 > k ? 7 : 601 > k ? 8 : "8"));
            B && (B[1] += " " + (k += "number" == typeof k ? ".x" : /[.+]/.test(k) ? "" : "+"));
            "Safari" == u && (!x || 45 < parseInt(x)) && (x = k)
        }
        "Opera" == u && (k = /\bzbov|zvav$/.exec(v)) ? (u += " ", m.unshift("desktop mode"), "zvav" == k ? (u += "Mini", x = null) : u += "Mobile", v = v.replace(RegExp(" *" + k + "$"), "")) : "Safari" == u && /\bChrome\b/.exec(B && B[1]) && (m.unshift("desktop mode"), u = "Chrome Mobile", x = null, /\bOS X\b/.test(v) ? (G =
            "Apple", v = "iOS 4.3+") : v = null);
        x && 0 == x.indexOf(k = /[\d.]+$/.exec(v)) && -1 < a.indexOf("/" + k + "-") && (v = String(v.replace(k, "")).replace(/^ +| +$/g, ""));
        B && !/\b(?:Avant|Nook)\b/.test(u) && (/Browser|Lunascape|Maxthon/.test(u) || "Safari" != u && /^iOS/.test(v) && /\bSafari\b/.test(B[1]) || /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|Web)/.test(u) && B[1]) && (k = B[B.length - 1]) && m.push(k);
        m.length && (m = ["(" + m.join("; ") + ")"]);
        G && C && 0 > C.indexOf(G) && m.push("on " + G);
        C && m.push((/^on /.test(m[m.length -
            1]) ? "" : "on ") + C);
        if (v) {
            var P = (k = / ([\d.+]+)$/.exec(v)) && "/" == v.charAt(v.length - k[0].length - 1);
            v = {
                architecture: 32,
                ...
                toString: function() {
                    var b = this.version;
                    return this.family + (b && !P ? " " + b : "") + (64 == this.architecture ? " 64-bit" : "")
                }
            }
        }(k = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(M)) && !/\bi686\b/i.test(M) ? (v && (v.architecture = 64, v.family = v.family.replace(RegExp(" *" + k), "")), u && (/\bWOW64\b/i.test(a) || I && /\w(?:86|32)$/.test(K.cpuClass || K.platform) && !/\bWin64; x64\b/i.test(a)) &&
            m.unshift("32-bit")) : v && /^OS X/.test(v.family) && "Chrome" == u && 39 <= parseFloat(x) && (v.architecture = 64);
        a || (a = null);
        t = {};
        t.description = a;
        t.layout = B && B[0];
        ...
        t.name && m.unshift(u);
        v && u && (v != String(v).split(" ")[0] || v != u.split(" ")[0] && !C) && m.push(C ? "(" + v + ")" : "on " +
            v);
    ...
    var z = m.hasOwnProperty,
        q = m.toString,
        w = c();
    "function" == typeof define && "object" == typeof define.amd && define.amd ? (r.platform = w, define(function() {
            return w
        })) : y &&
        p ? e(w, function(b, a) {
            y[a] = b
...
function getSize(a) {
    ...
    if (void 0 === window["inner" + a]) a = e["client" + a];
        ...
        b.innerHTML = "<style>@media(" + g + ":" + e["client" + a] + "px){body#vpw-test-b div#vpw-test-d{" + g + ":7px!important}}</style>";
        h.appendChild(b);
...
function sizeHandler() {
    ...
    if ($("#canvas")) {
        ...
        } else d < g && (h = g - d, d += h, e += CANVAS_HEIGHT / CANVAS_WIDTH * h);
        h = a / 2 - e / 2;
        var b = g / 2 - d / 2,
            f = CANVAS_WIDTH / d;
        if (b * f < -EDGEBOARD_X ||
            h * f < -EDGEBOARD_Y) s_iScaleFactor = Math.min(a / (CANVAS_HEIGHT - 2 * EDGEBOARD_Y), g / (CANVAS_WIDTH - 2 * EDGEBOARD_X)), d = Math.round(CANVAS_WIDTH * s_iScaleFactor), e = Math.round(CANVAS_HEIGHT * s_iScaleFactor), h = (a - e) / 2, b = (g - d) / 2, f = CANVAS_WIDTH / d;
        s_fInverseScaling = f;
        s_iOffsetX = -1 * b * f;
        s_iOffsetY = -1 * h * f;
        0 <= h && (s_iOffsetY = 0);
        ...
        s_bIsIphone ? (canvas = document.getElementById("canvas"),
            s_oStage.canvas.width = 2 * d, s_oStage.canvas.height = 2 * e, canvas.style.width = d + "px", canvas.style.height = e + "px", s_iScaleFactor = 2 * Math.min(d / CANVAS_WIDTH, e / CANVAS_HEIGHT), s_oStage.scaleX = s_oStage.scaleY = s_iScaleFactor) : s_bMobile || isChrome() ? ($("#canvas").css("width", d + "px"), $("#canvas").css("height", e + "px"), s_iScaleFactor = 1) : (s_oStage.canvas.width = d, s_oStage.canvas.height = e, s_iScaleFactor = Math.min(d / CANVAS_WIDTH, e / CANVAS_HEIGHT), s_oStage.scaleX = s_oStage.scaleY = s_iScaleFactor);
        0 > h || (h = (a - e) / 2);
        $("#canvas").css("top",
            h + "px");
...
function createBitmap(a, g, d) {
    ...
    g && d ? h.graphics.beginFill("#fff").drawRect(-g / 2, -d / 2, g, d) : h.graphics.beginFill("#ff0").drawRect(0, 0, a.width, a.height);
    e.hitArea = h;
    return e
}
...
function shuffle(a) {
    for (var g = a.length, d, e; 0 !== g;) e = Math.floor(Math.random() * g), --g, d = a[g], a[g] = a[e], a[e] = d;
    return a
}
...
function calculateIntersection(a, g) {
    ...
    f = Math.abs(f - c) - (d + h);
    l = Math.abs(l - p) - (e + b);
    return 0 > f && 0 > l ? (f = Math.min(Math.min(a.width, g.width), -f), l = Math.min(Math.min(a.height, g.height), -l), {
        x: Math.max(a.x, g.x),
        y: Math.max(a.y, g.y),
        width: f,
        height: l,
...
function getBounds(a, g) {
    ...
    if (a instanceof createjs.Container) {
        ...
        d.x =
            Math.min(Math.min(Math.min(h.x, f.x), b.x), e.x);
...
(function() {
    function a(a) {
        ...
        a = a || window.event;
        a.type in d ? document.body.className = d[a.type] : (document.body.className = this[g] ? "hidden" : "visible", "hidden" === document.body.className ? s_oMain.stopUpdate() : s_oMain.startUpdate())
    }
    var g = "hidden";
    g in document ? document.addEventListener("visibilitychange", a) : (g = "mozHidden") in document ? document.addEventListener("mozvisibilitychange", a) : (g = "webkitHidden") in
...
function playSound(a, g, d) {
    return !1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile ? (s_aSounds[a].play(), s_aSounds[a].volume(g), s_aSounds[a].loop(d), s_aSounds[a]) : null
}
...
function getParamValue(a) {
    for (var g = window.location.search.substring(1).split("&"), d = 0; d < g.length; d++) {
        var e = g[d].split("=");
        if (e[0] == a) return e[1]
    }
}
...
function CSpriteLibrary() {
    ...
    this.loadSprites = function() {
        for (var b in g) g[b].oSprite.oSpriteLibrary = this, g[b].oSprite.szKey =
            b, g[b].oSprite.onload = function() {
...
var CANVAS_WIDTH = 1280,
    ...
    TOTAL_MONEY, NUM_FICHES = 6,
    MIN_BET, MAX_BET,
    WIN_OCCURRENCE, TIME_FICHES_MOV = 1500,
    TIME_SHOW_DICES_RESULT, NUM_DICE_ROLLING_FRAMES = 34,
    NUM_BALL_SPIN_FRAMES = 200,
    NUM_HAND_FOR_ADS, ENABLE_FULLSCREEN, ENABLE_CHECK_ORIENTATION, SHOW_CREDITS, FONT1 = "arialbold",
    FONT2 = "Digital-7";
...
function CGameSettings() {
    ...
    this._initAttachFiches = function() {
        ...
        for (var a = [{
            ...
            ], b = 0; b < a.length; b++) e["lay_bet" + a[b].value] = {
            x: a[b].x + 20,
            y: a[b].y
        }, e["lose_bet" + a[b].value] = {
            x: a[b].x - 20,
            y: a[b].y + 20
        }, e["number" + a[b].value] = {
            x: a[b].x,
    ...
    this._initBetMultiplier = function() {
        ...
        g.big_6 = 1;
        g.big_8 = 1;
        for (var a = [4, 5, 6, 8, 9, 10], b = [.5, .66, .83, .83, .66, .5], d = [.45, .62, .8, .8, .62, .45], e = [2, 1.5, 1.2, 1.2, 1.5, 2], c = [1.8, 1.4, 1.17, 1.17, 1.4, 1.8], p = 0; p < a.length; p++) g["lay_bet" + a[p]] = b[p], g["lose_bet" + a[p]] = d[p], g["number" + a[p]] = e[p], g["win_bet" + a[p]] = c[p];
        g.any11_7 = 15;
        g.any_craps_7 =
            7;
        g.seven_bet = 4;
    ...
    this.getBetWinLoss = function(a, b, d) {
        ...
        switch (d) {
            case "pass_line":
                a === STATE_GAME_COME_OUT ? (f[6] = 1, f[10] = 1, c[1] = 1, c[2] = 1, c[11] = 1) : (f[b - 1] = 1, c[6] = 1);
                break;
            case "come":
                f[6] = 1;
                f[10] = 1;
            ...
            case "dont_pass1":
            case "dont_pass2":
                a === STATE_GAME_COME_OUT ? (f[1] = 1, f[2] = 1, f[11] = 1, c[6] = 1, c[10] = 1) : (f[6] = 1, c[b - 1] = 1);
                break;
            case "dont_come":
                f[1] = 1;
                f[2] = 1;
            ...
            case "horn2":
                ...
                break;
            case "horn12":
                f[11] = 1, c[1] = 1, c[2] = 1, c[3] = 1, c[4] = 1, c[5] = 1, c[6] = 1, c[7] = 1, c[8] = 1, c[9] = 1, c[10] = 1
        }
        return {
            win: f,
            lose: c
            ...
            case "pass_line":
                if (b === STATE_GAME_COME_OUT)
                    if (2 === a || 3 === a || 12 === a) e = 0;
                        ...
                        if (7 === a || 11 === a) e = f * s_oGameSettings.getBetMultiplier(c)
                    }
                else 7 === a ? e = 0 : a === d && (e = f * s_oGameSettings.getBetMultiplier(c));
                break;
            case "come":
                7 === a || 11 === a ? e = f * s_oGameSettings.getBetMultiplier(c) :
                    2 === a || 3 === a || 12 === a ? e = 0 : s_oGame.assignBetFromCome(a, c);
                break;
            case "dont_pass1":
            case "dont_pass2":
                b === STATE_GAME_COME_OUT ? 2 === a || 3 === a ? e = f * s_oGameSettings.getBetMultiplier(c) : 7 === a || 11 === a ? e = 0 : 12 === a && (e = f) : 7 === a ? e = f * s_oGameSettings.getBetMultiplier(c) : a === d && (e = 0);
                break;
            case "dont_come":
                2 === a || 7 === a ? e = f * s_oGameSettings.getBetMultiplier(c) : 7 === a || 11 === a ? e = 0 : s_oGame.assignBetFromDontCome(a, c);
                break;
            case "field":
                if (5 === a || 6 === a || 7 === a || 8 === a) e = 0;
                else if (e = f * s_oGameSettings.getBetMultiplier(c), 2 === a ||
                    12 === a) e *= 2;
                break;
            case "big_6":
                6 === a ? e = f * s_oGameSettings.getBetMultiplier(c) : 7 === a && (e = 0);
                break;
            case "big_8":
                8 === a ? e = f * s_oGameSettings.getBetMultiplier(c) : 7 === a && (e = 0);
                break;
            case "lay_bet4":
            case "lose_bet4":
                7 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "lay_bet4" === c && (e = roundDecimal(.05 * e, 2))) : 4 === a && (e = 0);
                break;
            case "lay_bet5":
            case "lose_bet5":
                7 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "lay_bet5" === c && (e = roundDecimal(.05 * e, 2))) : 5 === a && (e = 0);
                break;
            case "lay_bet6":
            case "lose_bet6":
                7 === a ? (e = f *
                    s_oGameSettings.getBetMultiplier(c), "lay_bet6" === c && (e = roundDecimal(.05 * e, 2))) : 6 === a && (e = 0);
                break;
            case "lay_bet8":
            case "lose_bet8":
                7 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "lay_bet8" === c && (e = roundDecimal(.05 * e, 2))) : 8 === a && (e = 0);
                break;
            case "lay_bet9":
            case "lose_bet9":
                7 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "lay_bet9" === c && (e = roundDecimal(.05 * e, 2))) : 9 === a && (e = 0);
                break;
            case "lay_bet10":
            case "lose_bet10":
                7 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "lay_bet10" === c && (e = roundDecimal(.05 *
                    e, 2))) : 10 === a && (e = 0);
                break;
            case "number4":
            case "win_bet4":
                b === STATE_GAME_COME_POINT && (4 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "number4" === c && (e = roundDecimal(.05 * f, 2))) : 7 === a && (e = 0));
                break;
            case "number5":
            case "win_bet5":
                b === STATE_GAME_COME_POINT && (5 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "number5" === c && (e = roundDecimal(.05 * f, 2))) : 7 === a && (e = 0));
                break;
            case "number6":
            case "win_bet6":
                b === STATE_GAME_COME_POINT && (6 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "number6" === c && (e = roundDecimal(.05 *
                    f, 2))) : 7 === a && (e = 0));
                break;
            case "number8":
            case "win_bet8":
                b === STATE_GAME_COME_POINT && (8 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "number8" === c && (e = roundDecimal(.05 * f, 2))) : 7 === a && (e = 0));
                break;
            case "number9":
            case "win_bet9":
                b === STATE_GAME_COME_POINT && (9 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "number9" === c && (e = roundDecimal(.05 * f, 2))) : 7 === a && (e = 0));
                break;
            case "number10":
            case "win_bet10":
                b === STATE_GAME_COME_POINT && (10 === a ? (e = f * s_oGameSettings.getBetMultiplier(c), "number10" === c && (e = roundDecimal(.05 *
                    f, 2))) : 7 === a && (e = 0));
                break;
            case "any11_7":
                ...
                break;
            case "any_craps_7":
                e = 2 === a || 3 === a || 12 === a ? f * s_oGameSettings.getBetMultiplier(c) : 0;
                break;
            case "seven_bet":
                e = 7 === a ? f * s_oGameSettings.getBetMultiplier(c) : 0;
                break;
            case "hardway6":
                e = 3 === g[0] && 3 === g[1] ? f * s_oGameSettings.getBetMultiplier(c) : 0;
                break;
            case "hardway10":
                e = 5 === g[0] && 5 === g[1] ? f * s_oGameSettings.getBetMultiplier(c) : 0;
                break;
            case "hardway8":
                e = 4 === g[0] && 4 === g[1] ? f * s_oGameSettings.getBetMultiplier(c) : 0;
                break;
            case "hardway4":
                e = 2 === g[0] && 2 === g[1] ? f * s_oGameSettings.getBetMultiplier(c) : 0;
                break;
            case "horn3":
...
function CFichesController(a) {
    ...
    this.setFicheOnTable = function(a, f, d) {
        -1 !== f.indexOf("any_craps_") ? f = "any_craps_7" : -1 !== f.indexOf("any11_") && (f = "any11_7");
    ...
    this.addFicheOnTable = function(a, f, e) {
        ...
        var b = s_oGameSettings.getAttachOffset(f),
            h = b.x;
        b = b.y;
        for (var l = 0; l < a.length; l++) e.push(this._attachFichesPile(a[l], f, h, b)), b -= 5
    };
    ...
    this._removeAllFichesOnTable = function() {
        if (e)
            for (var a = 0; a < e.length; a++) h.contains(e[a].getSprite()) && h.removeChild(e[a].getSprite())
    };
        ...
        if (d) {
            ...
            for (f in d)
                if ("pass_line" !== f && "dont_pass1" !== f && "dont_pass2" !== f) {
                    a += g[f];
                    for (var l = 0; l < d[f].length; l++) h.removeChild(d[f][l].getSprite());
                    delete g[f];
                    delete d[f];
                    delete e[f]
                }
...
var TEXT_MONEY = "MONEY",
    ...
    TEXT_RECHARGE_MSG =
    "PLEASE CLICK RECHARGE BUTTON TO PLAY AGAIN",
...
function CMain(a) {
    ...
    this.initContainer = function() {
        ...
        seekAndDestroy() ? b = new CPreloader :
    ...
    this._loadImages = function() {
        ...
        s_oSpriteLibrary.addSprite("enlight_any_craps",
        ...
        s_oSpriteLibrary.addSprite("enlight_dont_pass2",
        ...
        s_oSpriteLibrary.addSprite("hit_area_circle",
        ...
        s_oSpriteLibrary.addSprite("hit_area_any11",
        ...
        for (a = 0; a < NUM_DICE_ROLLING_FRAMES; a++) s_oSpriteLibrary.addSprite("launch_dices_" + a, "./sprites/launch_dice_anim/launch_dices_" + a + ".png");
...
function CTextButton(a, g, d, e, h, b, f, l, c) {
    ...
    this._init = function(a, b, f, d, e, g, h, l) {
        ...
        q.addChild(D, w);
        c.addChild(q);
        w = new CTLText(q, 10, 5, f.width - 20, f.height - 10, h, l, g, e, 1, 0, 0, d, !0, !0, !1, !1);
        this._initListener()
    };
    this.unload = function() {
        q.off("mousedown", A);
    ...
    this.buttonRelease = function() {
        p || (playSound("click", 1, !1), q.scaleX = r, q.scaleY = r, y[ON_MOUSE_UP] && y[ON_MOUSE_UP].call(m[ON_MOUSE_UP],
            z))
    };
    this.buttonDown = function() {
        p || (q.scaleX = .9 * r, q.scaleY = .9 * r, y[ON_MOUSE_DOWN] && y[ON_MOUSE_DOWN].call(m[ON_MOUSE_DOWN]))
    };
    ...
    this.tweenPosition = function(a, b, c, f, d, e, g) {
        createjs.Tween.get(q).wait(f).to({
            x: a,
            y: b
        }, c, d).call(function() {
            void 0 !== e && e.call(g)
...
function CGfxButton(a, g, d, e) {
    ...
    this._initListener = function() {
        ...
        !1 === s_bMobile && (m = n.on("rollover", this.mouseOver), A = n.on("rollout", this.mouseOut))
    };
    ...
    this.buttonRelease = function() {
        h || (playSound("click",
            1, !1), n.scaleX = 1, n.scaleY = 1, l[ON_MOUSE_UP] && l[ON_MOUSE_UP].call(c[ON_MOUSE_UP], p))
    };
    this.buttonDown = function() {
        h || (n.scaleX = .9, n.scaleY = .9, l[ON_MOUSE_DOWN] && l[ON_MOUSE_DOWN].call(c[ON_MOUSE_DOWN], p))
    };
...
function CFicheBut(a, g, d) {
    ...
    this.buttonRelease = function() {
        h || (playSound("click", 1, !1), r.scaleX = 1, r.scaleY = 1, l[ON_MOUSE_UP] && l[ON_MOUSE_UP].call(c[ON_MOUSE_UP], p), e = !e, m.visible = e)
    };
    this.buttonDown = function() {
        h || (r.scaleX = .9, r.scaleY = .9, l[ON_MOUSE_DOWN] && l[ON_MOUSE_DOWN].call(c[ON_MOUSE_DOWN], p))
    };
    this.setPosition = function(a, b) {
        r.x = a;
        r.y = b
...
function CBetTableButton(a, g, d, e, h) {
    ...
    this.buttonRelease = function() {
        playSound("click", 1, !1);
        b[ON_MOUSE_UP] && b[ON_MOUSE_UP].call(f[ON_MOUSE_UP], {
            button: c
        }, !1)
    };
    this.buttonDown = function() {
    ...
    this.mouseOver = function() {
        b[ON_MOUSE_OVER] && b[ON_MOUSE_OVER].call(f[ON_MOUSE_OVER], {
            enlight: c
        })
    };
    this.mouseOut = function() {
        b[ON_MOUSE_OUT] &&
            b[ON_MOUSE_OUT].call(f[ON_MOUSE_OUT], {
                enlight: c
            })
    };
    this.setPosition = function(a, b) {
...
function CToggle(a, g, d, e, h) {
    ...
    this._init = function(a, d, e, g, h) {
        ...
        b = g;
        c = createSprite(h, "state_" + b, e.width / 2 / 2, e.height / 2, e.width / 2, e.height);
        c.x = a;
        c.y = d;
        c.stop();
...
function CMenu() {
    var a, g, d, e, h, b, f, l, c, p, r, y, m, A = null,
        n = null,
        z;
    this._init = function() {
        ...
        SHOW_CREDITS ? (a = CANVAS_WIDTH - q.height / 2 - 10, g = q.height / 2 + 10, r = new CGfxButton(a, g, q, s_oStage), r.addEventListener(ON_MOUSE_UP,
            this._onCredits, this), q = s_oSpriteLibrary.getSprite("audio_icon"), f = a - q.width / 2 - 10) : (q = s_oSpriteLibrary.getSprite("audio_icon"), f = CANVAS_WIDTH - q.height / 2 - 10);
        l = q.height / 2 + 10;
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) y = new CToggle(f, l, q, s_bAudioActive, s_oStage), y.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
        q = window.document;
        var w = q.documentElement;
        A = w.requestFullscreen || w.mozRequestFullScreen || w.webkitRequestFullScreen || w.msRequestFullscreen;
        n = q.exitFullscreen || q.mozCancelFullScreen ||
            q.webkitExitFullscreen || q.msExitFullscreen;
        !1 === ENABLE_FULLSCREEN && (A = !1);
        A && screenfull.isEnabled && (q = s_oSpriteLibrary.getSprite("but_fullscreen"), d = 10 + q.width / 4, e = q.height / 2 + 10, m = new CToggle(d, e, q, s_bFullscreen, s_oStage), m.addEventListener(ON_MOUSE_UP, this._onFullscreenRelease, this));
    ...
    this.refreshButtonPos = function(c, n) {
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || y.setPosition(f - c, n + l);
    ...
    this._onFullscreenRelease = function() {
        s_bFullscreen ? n.call(window.document) : A.call(window.document.documentElement);
        sizeHandler()
    };
...
function CGame(a) {
    var g = !1,
        d, e, h, b, f, l, c, p, r, y, m, A, n, z, q, w, D, F, E, t;
    this._init = function() {
    ...
    this._setState = function(a) {
        ...
        switch (a) {
            case STATE_GAME_WAITING_FOR_BET:
                ...
                c++;
                c > NUM_HAND_FOR_ADS && (c = 0, $(s_oMain).trigger("show_interlevel_ad"));
                w.hideBlock()
        }
        D.setState(a)
    };
    ...
    this._generateWinLoss = function() {
        ...
        var c;
        for (c in m) {
            -1 !== c.indexOf("any11_") ? c = "any11" : -1 !== c.indexOf("any_craps") && (c = "any_craps");
            var d = s_oGameSettings.getBetWinLoss(e, b, c);
            var g = d.lose;
            d = d.win
        }
        if (Math.floor(100 * Math.random()) >= a)
            if (f > l) {
                do a = this._generateRandomDices(), c = a[0] + a[1]; while (0 === g[c - 1])
            } else {
                do a =
                    this._generateRandomDices(), c = a[0] + a[1], c = 0 === d[c - 1] ? !0 : !1; while (!c)
            }
        else if (f > l)
            if (-1 !== c.indexOf("hardway")) a = this._checkHardwayWin(c);
            else {
                do a = this._generateRandomDices(), c = a[0] + a[1]; while (0 === d[c - 1])
            }
        else if (-1 !== c.indexOf("hardway")) a = this._checkHardwayWin(c);
        else {
            do a = this._generateRandomDices(), c = a[0] + a[1], c = 0 === g[c - 1] ? !1 : !0; while (c)
        }
        r[0] = a[0];
        r[1] = a[1]
    };
    ...
    this.dicesAnimEnded = function() {
        ...
        if (e === STATE_GAME_COME_OUT) {
            2 !== a && 3 !== a && 12 !== a && 7 !== a && 11 !== a && this._assignNumber(a);
            this._checkWinForBet();
            if (0 < y.length) {
                d = !0;
                for (var c = 0; c < A.length; c++) n.removeBet(A[c]),
                    delete m[A[c]];
            ...
            b === a ? (q.switchOff(), this._setState(STATE_GAME_WAITING_FOR_BET)) : 7 === a && (q.switchOff(), this._setState(STATE_GAME_WAITING_FOR_BET))
        }
    ...
    this._checkWinForBet = function() {
        ...
        A = [];
        for (var d in m) {
            var f = d; - 1 !== d.indexOf("any11_") ? d = "any11_7" : -1 !== d.indexOf("any_craps") && (d = "any_craps_7");
            ...
            if (-1 !== h) {
                ...
                for (var t = 0; t < l.length; t++) {
                    ...
                    if (0 < h) {
                        ...
                        playSound("win", .2, !1)
                    } else p = s_oGameSettings.getAttachOffset("oDealerWin"), playSound("lose", .2, !1);
                    l[t].setEndPoint(p.x, p.y)
                }
                n.decreaseBet(g);
                0 < h && (n.showWin(n.getBetAmountInPos(f) + h), J -= h, f = l[0].getStartingPos(), new CScoreText(h + TEXT_CURRENCY, f.x, f.y))
            }
        }
        0 < c && (w.refreshMsgHelp(TEXT_YOU_WIN + ": " + c), setTimeout(function() {
            w.clearMsgHelp()
        }, 3E3))
    };
    ...
    this.onRoll = function() {
        0 !== n.getCurBet() && (n.getCurBet() < MIN_BET ? (F.show(TEXT_ERROR_MIN_BET),
            w.enableBetFiches(), w.enableRoll(!0)) : w.isBlockVisible() || (w.showBlock(), e === STATE_GAME_WAITING_FOR_BET && this._setState(STATE_GAME_COME_OUT), $(s_oMain).trigger("bet_placed", n.getCurBet()), this._prepareForRolling(), this._startRollingAnim()))
    };
    ...
    this._onShowBetOnTable = function(a) {
        if (!d) {
            var b = a.button,
                ...
                e = n.getCurBet();
            0 > n.getCredit() - f ? F.show(TEXT_ERROR_NO_MONEY_MSG) : e + f > MAX_BET ? F.show(TEXT_ERROR_MAX_BET_REACHED) : (m[a.button] = void 0 === m[a.button] ? f : m[a.button] + f, n.addFicheOnTable(f, c, b), w.setMoney(n.getCredit()), w.setCurBet(n.getCurBet()), w.enableRoll(!0), w.enableClearButton(), w.refreshMsgHelp(TEXT_READY_TO_ROLL, !0), playSound("chip", 1, !1))
        }
    };
    ...
    this.onClearAllBets = function() {
        ...
        if (e === STATE_GAME_COME_POINT) {
            ...
            for (var a in m) "pass_line" !== a && "dont_pass1" !== a && "dont_pass2" !== a && delete m[a]
    ...
    this._updateDistributeFiches = function() {
        h += s_iTimeElaps;
        if (h > TIME_FICHES_MOV) h = 0, d = !1, playSound("fiche_collect", 1, !1);
        else
            for (var a = s_oTweenController.easeInOutCubic(h, 0, 1, TIME_FICHES_MOV), b = 0; b < y.length; b++) y[b].updatePos(a)
    };
    this.update = function() {
        !1 !== g && (d && this._updateDistributeFiches(), z.isVisible() && z.update())
    };
    s_oGame = this;
    TOTAL_MONEY = a.money;
    MIN_BET = a.min_bet;
...
function CInterface() {
    var a, g, d, e, h, b, f, l, c, p, r, y, m, A, n, z, q, w, D = null,
        F = null,
        E;
    this._init = function() {
        ...
        t.y = 603;
        s_oStage.addChild(t);
        new CTLText(s_oStage, 260, 616, 140, 16, 16, "center", "#fff", FONT1, 1, 0, 0, TEXT_MONEY, !0, !0, !1, !1);
        y = new CTLText(s_oStage, 260, 636, 140, 16, 16, "center", "#fff", FONT1, 1, 0, 0, " ", !0, !0, !1, !1);
        t = createBitmap(s_oSpriteLibrary.getSprite("but_bg"));
        t.x = 410;
        t.y = 603;
        s_oStage.addChild(t);
        new CTLText(s_oStage, 419, 616, 140, 16, 16, "center",
            "#fff", FONT1, 1, 0, 0, TEXT_CUR_BET, !0, !0, !1, !1);
        m = new CTLText(s_oStage, 419, 636, 140, 16, 16, "center", "#fff", FONT1, 1, 0, 0, " ", !0, !0, !1, !1);
        n = createBitmap(s_oSpriteLibrary.getSprite("but_bets"));
        n.x = 575;
        n.y = 610;
        s_oStage.addChild(n);
        new CTLText(s_oStage, n.x + 4, n.y + 4, 140, 40, 16, "center", "#fff", FONT1, 1.2, 0, 0, TEXT_MIN_BET + ": " + MIN_BET + "\n" + TEXT_MAX_BET + ": " + MAX_BET, !0, !0, !0, !1);
        t = createBitmap(s_oSpriteLibrary.getSprite("display_bg"));
        t.x = 880;
        t.y = 210;
        s_oStage.addChild(t);
        A = new CTLText(s_oStage, t.x + 114, t.y + 13, 130,
            80, 20, "center", "#ffde00", FONT2, 1, 0, 0, TEXT_WAITING_BET, !0, !0, !0, !1);
        l = TEXT_WAITING_BET;
        z = new CTextButton(1030, 162, s_oSpriteLibrary.getSprite("roll_but"), "  " + TEXT_ROLL, FONT1, "#fff", 22, "right", s_oStage);
        z.disable();
        z.addEventListener(ON_MOUSE_UP, this._onRoll, this);
        q = new CGfxButton(764, 636, s_oSpriteLibrary.getSprite("but_clear_all"), s_oStage);
        q.addEventListener(ON_MOUSE_UP, this._onClearAllBet, this);
        this._initFichesBut();
        f = 0;
        c[f].select();
        t = (new createjs.Graphics).beginFill("rgba(0,0,0,0.01)").drawRect(0,
        ...
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) t = s_oSpriteLibrary.getSprite("audio_icon"), h = a - t.width / 2 - 10, b = t.height / 2 + 10, r = new CToggle(h, b, t, s_bAudioActive, s_oStage), r.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
        t = window.document;
        var J = t.documentElement;
        D = J.requestFullscreen || J.mozRequestFullScreen || J.webkitRequestFullScreen || J.msRequestFullscreen;
        F = t.exitFullscreen || t.mozCancelFullScreen || t.webkitExitFullscreen || t.msExitFullscreen;
        !1 === ENABLE_FULLSCREEN && (D = !1);
        D && screenfull.isEnabled && (t = s_oSpriteLibrary.getSprite("but_fullscreen"), d = 10 + t.width / 4, e = t.height / 2 + 10, w = new CToggle(d, e, t, s_bFullscreen, s_oStage), w.addEventListener(ON_MOUSE_UP, this._onFullscreenRelease, this));
    ...
    this.refreshButtonPos = function(c, f) {
        !1 !== DISABLE_SOUND_MOBILE && !1 !== s_bMobile || r.setPosition(h - c, b + f);
    ...
    this._initFichesBut = function() {
        ...
        for (var b = 0; b < NUM_FICHES; b++) {
            ...
            c[b] = new CFicheBut(124,
                a, d);
            c[b].addEventListenerWithParams(ON_MOUSE_UP, this._onFicheSelected, this, [b]);
            a += d.height + 25
        }
    };
    ...
    this.refreshMoney = function(a, b) {
        new CRollingTextController(y.getText(), null, a, parseFloat(b), 4E3, EASE_LINEAR, TEXT_CURRENCY)
    };
    ...
    this._onBetRelease = function(a) {
        null !==
            a.numbers && s_oGame._onShowBetOnTable({
                button: a.name
            }, !1)
    };
...
function CMsgBox() {
    ...
    this._init = function() {
        ...
        a.on("click", function() {});
        d.addChild(a);
        g = new CTLText(d, CANVAS_WIDTH / 2 - 240, 240, 480, 290, 24, "center", "#fff", FONT1, 1, 0, 0, " ", !0, !0, !0, !1)
    };
    this.unload = function() {
...
function CTweenController() {
    ...
    this.easeInOutCubic = function(a, g, d, e) {
        return 1 > (a /= e / 2) ? d / 2 * a * a * a + g : d / 2 * ((a -= 2) * a * a + 2) + g
    };
...
function CTableController() {
    ...
    this._initEnlights = function() {
        g = [];
        var a = new CEnlight(175, 162, s_oSpriteLibrary.getSprite("enlight_pass_line"), d);
        g.pass_line = a;
        a = new CEnlight(365, 476, s_oSpriteLibrary.getSprite("enlight_dont_pass1"), d);
        g.dont_pass1 = a;
        a =
            new CEnlight(227, 127, s_oSpriteLibrary.getSprite("enlight_dont_pass2"), d);
        g.dont_pass2 = a;
        a = new CEnlight(279, 127, s_oSpriteLibrary.getSprite("enlight_dont_come"), d);
        g.dont_come = a;
        ...
        for (var f = [{
                ...
                x: 795,
                y: 127
            }], e = 0; 6 > e; e++) a = new CEnlight(f[e].x, f[e].y, s_oSpriteLibrary.getSprite("enlight_lay_bet"), d), g["lay_bet" +
            f[e].value] = a, a = new CEnlight(f[e].x, f[e].y + 30, s_oSpriteLibrary.getSprite("enlight_lose_bet"), d), g["lose_bet" + f[e].value] = a, a = new CEnlight(f[e].x, f[e].y + 41, s_oSpriteLibrary.getSprite("enlight_number"), d), g["number" + f[e].value] = a, a = new CEnlight(f[e].x, f[e].y + 125, s_oSpriteLibrary.getSprite("enlight_lose_bet"), d), g["win_bet" + f[e].value] = a;
        ...
        g.big_8 = a;
        a = new CEnlight(281,
            391, s_oSpriteLibrary.getSprite("enlight_field"), d);
        g.field = a;
        f = 401;
        var c = 409;
        for (e = 0; 7 > e; e++) a = new CEnlight(806, f, s_oSpriteLibrary.getSprite("enlight_circle"), d), g["any11_" + e] = a, a = new CEnlight(840, c, s_oSpriteLibrary.getSprite("enlight_circle"), d), g["any_craps_" + e] = a, f += 37, c += 34;
        a = new CEnlight(877, 551, s_oSpriteLibrary.getSprite("enlight_any11"), d);
        g["any11_" + e] = a;
        a = new CEnlight(877, 612, s_oSpriteLibrary.getSprite("enlight_any_craps"), d);
        g["any_craps_" + e] = a;
        a = new CEnlight(877, 371, s_oSpriteLibrary.getSprite("enlight_proposition1"),
            d);
        g.hardway6 = a;
        a = new CEnlight(1032, 371, s_oSpriteLibrary.getSprite("enlight_proposition1"), d);
        g.hardway10 = a;
        a = new CEnlight(877, 431, s_oSpriteLibrary.getSprite("enlight_proposition1"), d);
        g.hardway8 = a;
        a = new CEnlight(1032, 431, s_oSpriteLibrary.getSprite("enlight_proposition1"), d);
        g.hardway4 = a;
        a = new CEnlight(877, 491, s_oSpriteLibrary.getSprite("enlight_proposition2"), d);
        g.horn3 = a;
        a = new CEnlight(980, 491, s_oSpriteLibrary.getSprite("enlight_proposition2"), d);
        g.horn2 = a;
        a = new CEnlight(1083, 491, s_oSpriteLibrary.getSprite("enlight_proposition2"),
            d);
        g.horn12 = a;
    ...
    this._initButtonBets = function() {
        a = [];
        var b = new CBetTableButton(485, 371, s_oSpriteLibrary.getSprite("hit_area_pass_line"), "pass_line", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.pass_line = b;
        b = new CBetTableButton(580, 501, s_oSpriteLibrary.getSprite("hit_area_dont_pass1"),
            "dont_pass1", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.dont_pass1 = b;
        b = new CBetTableButton(252, 259, s_oSpriteLibrary.getSprite("hit_area_dont_pass2"), "dont_pass2", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut,
            this));
        a.dont_pass2 = b;
        b = new CBetTableButton(321, 195, s_oSpriteLibrary.getSprite("hit_area_dont_come"), "dont_come", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.dont_come = b;
        b = new CBetTableButton(536, 327, s_oSpriteLibrary.getSprite("hit_area_come"), "come", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER,
            this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.come = b;
        b = new CBetTableButton(536, 433, s_oSpriteLibrary.getSprite("hit_area_field"), "field", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.field = b;
        b = new CBetTableButton(304, 480, s_oSpriteLibrary.getSprite("hit_area_big_8"), "big_8", d);
        b.addEventListener(ON_MOUSE_DOWN,
            this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.big_8 = b;
        b = new CBetTableButton(274, 455, s_oSpriteLibrary.getSprite("hit_area_big_6"), "big_6", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.big_6 = b;
        for (var f = [{
                ...
                x: 838,
                y: 142
            }], e = 0; 6 > e; e++) b = new CBetTableButton(f[e].x, f[e].y, s_oSpriteLibrary.getSprite("hit_area_lay_bet"), "lay_bet" + f[e].value, d), b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this), !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)), a["lay_bet" + f[e].value] = b, b = new CBetTableButton(f[e].x, f[e].y + 20, s_oSpriteLibrary.getSprite("hit_area_lose_bet"),
            "lose_bet" + f[e].value, d), b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this), !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)), a["lose_bet" + f[e].value] = b, b = new CBetTableButton(f[e].x, f[e].y + 69, s_oSpriteLibrary.getSprite("hit_area_number"), "number" + f[e].value, d), b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this), !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT,
            this._onBetNumberOut, this)), a["number" + f[e].value] = b, b = new CBetTableButton(f[e].x, f[e].y + 116, s_oSpriteLibrary.getSprite("hit_area_lose_bet"), "win_bet" + f[e].value, d), b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this), !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)), a["win_bet" + f[e].value] = b;
        f = [{
            x: 820,
            y: 299
        }, {
        ...
        for (var c = 0; 7 > c; c++) b = new CBetTableButton(f[c].x, f[c].y + 116, s_oSpriteLibrary.getSprite("hit_area_circle"), "any11_7", d), b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this), !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)), a["any11_" + c] = b, b = new CBetTableButton(e[c].x, e[c].y + 116, s_oSpriteLibrary.getSprite("hit_area_circle"), "any_craps_7",
            d), b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this), !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)), a["any_craps_" + c] = b;
        b = new CBetTableButton(1031, 355, s_oSpriteLibrary.getSprite("hit_area_seven"), "seven_bet", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.seven_bet = b;
        b = new CBetTableButton(954, 401, s_oSpriteLibrary.getSprite("hit_area_proposition1"), "hardway6", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.hardway6 = b;
        b = new CBetTableButton(1109, 401, s_oSpriteLibrary.getSprite("hit_area_proposition1"), "hardway10", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER,
            this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.hardway10 = b;
        b = new CBetTableButton(954, 460, s_oSpriteLibrary.getSprite("hit_area_proposition1"), "hardway8", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.hardway8 = b;
        b = new CBetTableButton(1109, 460, s_oSpriteLibrary.getSprite("hit_area_proposition1"), "hardway4", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.hardway4 = b;
        b = new CBetTableButton(928, 521, s_oSpriteLibrary.getSprite("hit_area_proposition2"), "horn3", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.horn3 =
            b;
        b = new CBetTableButton(1032, 521, s_oSpriteLibrary.getSprite("hit_area_proposition2"), "horn2", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.horn2 = b;
        b = new CBetTableButton(1136, 521, s_oSpriteLibrary.getSprite("hit_area_proposition2"), "horn12", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER,
            this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.horn12 = b;
        b = new CBetTableButton(1032, 581, s_oSpriteLibrary.getSprite("hit_area_any11"), "any11_7", d);
        b.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.any11_7 = b;
        b = new CBetTableButton(1032, 628, s_oSpriteLibrary.getSprite("hit_area_any_craps"), "any_craps_7", d);
        b.addEventListener(ON_MOUSE_DOWN,
            this._onBetPress, this);
        !1 === s_bMobile && (b.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this), b.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        a.any_craps_7 = b
    ...
    this.setState = function(b) {
        switch (b) {
            case STATE_GAME_WAITING_FOR_BET:
                for (var d in a) "come" === d || "dont_come" === d ? a[d].setVisible(!1) : a[d].setVisible(!0);
                break;
            case STATE_GAME_COME_POINT:
                for (d in a) "pass_line" === d || "dont_pass1" === d || "dont_pass2" === d ? a[d].setVisible(!1) : a[d].setVisible(!0)
        }
    };
    this.unload = function() {
        for (var a = 0; a <
    ...
    this._onBetPress = function(a) {
        null !== a.numbers && e[ON_SHOW_BET_ON_TABLE] && e[ON_SHOW_BET_ON_TABLE].call(h[ON_SHOW_BET_ON_TABLE], a, !1)
    };
    this._onBetNumberOver = function(a) {
        null !== a.numbers && e[ON_SHOW_ENLIGHT] && e[ON_SHOW_ENLIGHT].call(h[ON_SHOW_ENLIGHT], a)
    };
    this._onBetNumberOut = function(a) {
        null !== a.numbers && e[ON_HIDE_ENLIGHT] && e[ON_HIDE_ENLIGHT].call(h[ON_HIDE_ENLIGHT],
            a)
    };
...
function CFiche(a, g, d, e, h) {
    ...
    this._init = function(a, d, e, f, g) {
        ...
        c.regX = f.width / 2;
        c.regY = f.height / 2;
        g ? (c.scaleX = g, c.scaleY = g) : (c.scaleX = .6, c.scaleY = .6);
        b = e;
        p.addChild(c)
    };
...
function CDicesAnim(a, g) {
    ...
    this._init = function(a, b) {
        ...
        m.y = b;
        s_oStage.addChild(m);
        var d = (new createjs.Graphics).beginFill("rgba(0,0,0,0.6)").drawRect(0, 0, CANVAS_WIDTH, CANVAS_HEIGHT);
        ...
        for (d = 0; d < NUM_DICE_ROLLING_FRAMES; d++) {
            var g = createBitmap(s_oSpriteLibrary.getSprite("launch_dices_" +
                d));
            g.x = 162;
            g.y = 150;
            g.visible = !1;
    ...
    this._onDiceBAnimEnded = function(a) {
        -1 !== a.currentTarget.currentAnimation.indexOf("stop_anim") && (z.setShowNumberInfo(), setTimeout(function() {
            z.hide()
    ...
    this.update = function() {
        !1 !== d && (h++, 1 === h && (h = 0, e === NUM_DICE_ROLLING_FRAMES -
            1 ? (d = !1, this._setAnimForDiceResult()) : this.nextFrame()))
    };
    var z = this;
    this._init(a, g)
}
...
function CGameOver() {
    ...
    this._init = function() {
        ...
        d.addChild(e);
        new CTLText(d, CANVAS_WIDTH / 2 - 240, 240, 480, 72, 36, "center", "#fff", FONT1, 1, 0, 0, TEXT_NO_MONEY, !0, !0, !0, !1);
        new CTLText(d, CANVAS_WIDTH / 2 - 240, 400, 480, 40, 20, "center", "#fff", FONT1, 1, 0, 0, TEXT_RECHARGE_MSG, !0, !0, !0, !1);
        a = new CTextButton(CANVAS_WIDTH / 2 + 170, 510, s_oSpriteLibrary.getSprite("but_bg"), TEXT_RECHARGE, FONT1, "#fff", 18, "center", s_oStage);
        a.addEventListener(ON_MOUSE_UP, this._onRecharge, this);
        d.addChild(a.getSprite());
        g = new CTextButton(CANVAS_WIDTH / 2 - 170, 510, s_oSpriteLibrary.getSprite("but_bg"), TEXT_EXIT, FONT1, "#fff", 18, "center", s_oStage);
...
function CCreditsPanel() {
    ...
    this._init = function() {
        ...
        h.alpha = .01;
        l = h.on("click", this._onLogoButRelease);
        f.addChild(h);
        c = s_oSpriteLibrary.getSprite("but_exit");
        a = CANVAS_WIDTH / 2 + 234;
        d = new CGfxButton(a, 254, c, f);
        ...
        p.y = CANVAS_HEIGHT / 2;
        f.addChild(p);
        b = new createjs.Text("Muhammad Iqbal", "30px Arial", "#ffffff");
        b.x = CANVAS_WIDTH / 2;
        b.y = 444;
        b.textAlign = "center";
        f.addChild(b)
...
function CRollingTextController(a, g, d, e, h, b, f) {
    ...
    this.update = function() {
        l++;
        if (l > c) l = 0, F.text = r.toFixed(2) + z, null !== E && (E.text = r.toFixed(2) + z), clearInterval(A), null !== q[ON_CONTROLLER_END] && void 0 !== q[ON_CONTROLLER_END] && q[ON_CONTROLLER_END].call(w[ON_CONTROLLER_END], this), 0 < m ? this.setUpdateInfo(m) : null !== q[ON_CONTROLLER_REMOVE] && void 0 !== q[ON_CONTROLLER_REMOVE] && q[ON_CONTROLLER_REMOVE].call(w[ON_CONTROLLER_REMOVE], this);
        else {
            switch (n) {
                case EASE_BACKIN:
                    var a =
                        s_oTweenController.easeInBack(l, 0, 1, c);
                    break;
                case EASE_BACKOUT:
                ...
                case EASE_QUART_BACKIN:
                    ...
                    break;
                default:
                    a = s_oTweenController.easeLinear(l,
                        0, 1, c)
            }
            a = s_oTweenController.tweenValue(p, r, a);
            for (var b = 0; b < D.length; b++) a > D[b].step && !D[b].flag && (D[b].flag = !0, null !== q[ON_CONTROLLER_ROLL] && q[ON_CONTROLLER_ROLL].call(w[ON_CONTROLLER_ROLL], b));
...
function CPuck(a, g, d) {
    ...
    this._init = function() {
        ...
        h = createSprite(l, "off", d.width / 2 / 2, d.height / 2, d.width / 2, d.height);
        h.x = a;
        h.y = g;
        b.addChild(h)
    };
...
function CDicesTopDownView(a, g, d) {
    ...
    this._init = function(a, d) {
        ...
        h = createSprite(g, "dice_1", c.width / 6 / 2, c.height /
            2, c.width / 6, c.height);
        h.x = c.width / 6 / 2 + 10;
        h.y = c.height / 2;
        f.addChild(h);
        ...
        g = new createjs.SpriteSheet(g);
        b = createSprite(g, "dice_1", c.width / 6 / 2, c.height / 2, c.width / 6, c.height);
        b.x = c.width / 6 / 2 + c.width / 6 + 20;
        b.y = c.height / 2;
        f.addChild(b);
        e = new CTLText(f, c.width / 6 - 80, c.height + 6, 190, 20, 20, "center", "#fff",
            FONT1, 1, 0, 0, TEXT_COME_OUT, !0, !0, !1, !1)
    };
...
function CAreYouSurePanel(a) {
    ...
    this._init = function() {
        ...
        d = new CTLText(f, CANVAS_WIDTH / 2 - 240, .5 * CANVAS_HEIGHT - 100, 480, 120, 60, "center", "#fff", FONT1, 1, 0, 0, TEXT_ARE_SURE, !0, !0, !0, !1);
        e = new CGfxButton(CANVAS_WIDTH / 2 + 186, d.getY() + 200, s_oSpriteLibrary.getSprite("but_yes"),
            f);
        e.addEventListener(ON_MOUSE_UP, this._onButYes, this);
        h = new CGfxButton(CANVAS_WIDTH / 2 - 186, d.getY() + 200, s_oSpriteLibrary.getSprite("but_not"), f);
...
function CScoreText(a, g, d) {
    ...
    this._init = function(a, b, d) {
        ...
        createjs.Tween.get(e).to({
            ...
            createjs.Tween.get(e).wait(1E3).to({
                alpha: 0
            }, 500)
        });
        this.moveUp()
...
CTLText.prototype = {
    ...
    setShadow: function(a, g, d, e) {
        null !== this._oText && (this._oText.shadow = new createjs.Shadow(a, g, d, e))
    },
    setColor: function(a) {
        this._oText.color = a
    },
